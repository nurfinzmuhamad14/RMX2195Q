...
#elif CONFIG_OPPO_FINGERPRINT_PLATFORM == 855 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6125 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 7150 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 7250 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 6885 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 8250 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 4250
#include <linux/uaccess.h>
#else
...
static int fp_gpio_parse_child_dts(struct fp_data *fp_data)
{
    ...
    for_each_available_child_of_node(np, child) {
        ...
        for (child_node_index = 0; child_node_index < child_amount; child_node_index++) {
            ...
            //judge if find the matched sensor
